...
class Wwwis {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wwwis_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wwwis_Loader. Orchestrates the hooks of the plugin.
	 * - Wwwis_i18n. Defines internationalization functionality.
	 * - Wwwis_Admin. Defines all hooks for the admin area.
	 * - Wwwis_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wwwis_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wwwis_Loader    Orchestrates the hooks of the plugin.
	 */
